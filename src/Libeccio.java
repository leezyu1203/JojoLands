...
public class Libeccio extends Main {
    ...
    protected static void libeccio(){
        ...
        case 2:
            System.out.println("Restaurant: Liberrio\nWaiting List");
            RestaurantsSortings r= new RestaurantsSortings();
            Libeccio libeccio= new Libeccio();
            r.display(libeccio.lb);
            r.libeccioProcessingList(libeccio.lb, currentDay);
            break;
        ...
        case 3:
            ...
            EatingHabits.display(liberrioFood);
            System.out.println("\n[1] Add new food");
